...
# HD input (output = input in auto-encoding!)
HD_DIM_INPUT_MIN=1
HD_DIM_INPUT_MAX=5
N_HD_DIM_INPUT=1
EMBED_DIM_INPUT=10
...
# Paths
OUTPUT_DIR="results/autoencoding"
SIGNAL_CACHE_DIR="hd_signals/autoencoding"
LOG_DIR="logs/autoencoding"
...
Auto-encoding task experiment (reconstructs INPUT from network response).
...
Paths:
  --output_dir DIR              Output (default: results/autoencoding)
  --signal_cache_dir DIR        HD cache (default: hd_signals/autoencoding)
