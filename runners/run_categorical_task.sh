...
# Paths
OUTPUT_DIR="results/categorical"
SIGNAL_CACHE_DIR="hd_signals/categorical"
LOG_DIR="logs/categorical"
...
Paths:
  --output_dir DIR              Output (default: results/categorical)
  --signal_cache_dir DIR        HD cache (default: hd_signals/categorical)
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --decision_window) DECISION_WINDOW="$2"; shift 2 ;;
...
for SESSION_ID in $(seq ${SESSION_START} ${SESSION_END}); do
    log_message "Starting categorical session ${SESSION_ID}..."
