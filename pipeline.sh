...
#
# 1. Run the spontaneous experiment and wait for it to finish
./runners/run_encoding_experiment.sh --session_ids "1" --static_input_mode common_tonic --hd_input_mode common_tonic --v_th_distribution uniform --hd_dim_max 9 --n_hd 3 --n_v_th 3 --n_g 3 --input_rate_min 30 --input_rate_max 50 --n_input_rates 2 --nproc 54
./runners/run_encoding_experiment.sh --session_ids "2" --static_input_mode common_tonic --hd_input_mode common_tonic --v_th_distribution uniform --hd_dim_max 9 --n_hd 3 --n_v_th 3 --n_g 3 --input_rate_min 30 --input_rate_max 50 --n_input_rates 2 --nproc 54
./runners/run_encoding_experiment.sh --session_ids "3" --static_input_mode common_tonic --hd_input_mode common_tonic --v_th_distribution uniform --hd_dim_max 9 --n_hd 3 --n_v_th 3 --n_g 3 --input_rate_min 30 --input_rate_max 50 --n_input_rates 2 --nproc 54
