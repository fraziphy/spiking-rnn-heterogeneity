...
#
# 1. Run the spontaneous experiment and wait for it to finish
./runners/run_encoding_experiment.sh --session_ids "1" --static_input_mode common_tonic --hd_input_mode common_tonic --v_th_distribution uniform --hd_dim_max 9 --n_hd 2 --n_v_th 2 --n_g 2 --input_rate_min 30 --input_rate_max 50 --n_input_rates 2 --nproc 16
./runners/run_encoding_experiment.sh --session_ids "1" --static_input_mode common_tonic --hd_input_mode common_tonic --v_th_distribution uniform --hd_dim_max 1 --embed_dim 1 --n_hd 1 --n_v_th 2 --n_g 2 --input_rate_min 30 --input_rate_max 50 --n_input_rates 2 --nproc 8
./runners/run_spontaneous_experiment.sh --session_ids "1" --v_th_distribution uniform --static_input_mode common_tonic --n_v_th 2 --n_g 2 --input_rate_min 30 --input_rate_max 50 --n_input_rates 2 --nproc 8
./runners/run_stability_experiment.sh --session_ids "1" --n_v_th 2 --n_g 2 --input_rate_min 30 --input_rate_max 50 --n_input_rates 2 --nproc 8
